	...
	*out = *in
	...
	if in.KubeProxy != nil {
		...
		if *in == nil {
			...
			*out = new(ClusterKubernetesKubeProxy)
			(*in).DeepCopyInto(*out)
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterKubernetesKubeProxy) DeepCopyInto(out *ClusterKubernetesKubeProxy) {
	*out = *in
	if in.FeatureGates != nil {
		in, out := &in.FeatureGates, &out.FeatureGates
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterKubernetesKubeProxy.
func (in *ClusterKubernetesKubeProxy) DeepCopy() *ClusterKubernetesKubeProxy {
	if in == nil {
		return nil
	}
	out := new(ClusterKubernetesKubeProxy)
