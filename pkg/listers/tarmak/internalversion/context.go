...
type ContextLister interface {
	...
	List(selector labels.Selector) (ret []*tarmak.Context, err error)
...
// List lists all Contexts in the indexer.
func (s *contextLister) List(selector labels.Selector) (ret []*tarmak.Context, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*tarmak.Context))
	})
	return ret, err
}
...
type ContextNamespaceLister interface {
	...
	Get(name string) (*tarmak.Context, error)
...
// List lists all Contexts in the indexer for a given namespace.
func (s contextNamespaceLister) List(selector labels.Selector) (ret []*tarmak.Context, err error) {
...
// Get retrieves the Context from the indexer for a given namespace and name.
func (s contextNamespaceLister) Get(name string) (*tarmak.Context, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(tarmak.Resource("context"), name)
	}
	return obj.(*tarmak.Context), nil
}
