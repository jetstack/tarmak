...
This instance pool can be extended with an annotation ``tarmak.io/jenkins-certificate-arn``. The value of this annotation will be ARN arn pointing to an Amazon Certificate.
