...
then there is a mismatch between the your keypair's public key stored by AWS and your local private key. To remedy this you must either create a new key pair and upload it to AWS manually, or delete your existing keypair through the AWS console and re-run ``tarmak clusters apply``.
