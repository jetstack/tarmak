...
DIFFROOT="${SCRIPT_ROOT}/docs/generated/cmd"
TMP_DIFFROOT="${SCRIPT_ROOT}/_tmp/docs/generated/cmd"
...
then
  ...
  echo "----"
  echo "${DIFFROOT} is out of date. Please run hack/update-cmd-docs.sh"
  exit 1
fi
